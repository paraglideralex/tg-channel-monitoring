...
public class GetUsersCountForPeriodQueryTest
{
    ...
    public void Basic_OneDayTimeSpan()
    {
        ...
        var result = usersCountForPeriodCore.Execute(finalCount, repoOutput, new DateTime(2025, 1, 7, 20, 0, 0), TimeSpan.FromDays(1));
    ...
    public void Basic_6HoursTimeSpan()
    {
        ...
        var result = usersCountForPeriodCore.Execute(finalCount, repoOutput, new DateTime(2025, 1, 7, 20, 0, 0), TimeSpan.FromHours(6));
